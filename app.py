...
if selection == 'About':
    ...
    st.write("This Stock Market Prediction Web App is developed by a group of students from GH Raisoni College of Engineering, Nagpur, in the Department of Information Technology.")
    ...
    st.write("Under the Guidance of Prof. Rajesh Nakhate")
